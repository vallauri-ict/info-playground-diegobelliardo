...
namespace MockTestCollectionsAndLists
{
    public partial class FormMain : Form
    {
        ...
        private bool CheckStudentValidation()
        {
            ...
            {
                if (int.TryParse(txtIdStudente.Text, out test) && DateTime.TryParse(txtDataNascitaStudente.Text, out DateTime dateTest) &&
                    int.TryParse(txtIdClasseStudente.Text, out test))
                    return true;
            }
            return false;
        }
        ...
        private bool CheckYearValidation()
        {
            ...
            {
                if (int.TryParse(txtIdAnni.Text, out test) && int.TryParse(txtAnnoAnni.Text, out test))
                    return true;
            }
            return false;
        }
        ...
        private bool CheckClassValidation()
        {
            ...
            {
                if (int.TryParse(txtIdClasse.Text, out test) && int.TryParse(txtAnnoIdClasse.Text, out int test2) && int.TryParse(txtSezioneIdClasse.Text, out test))
                    return true;
            }
            return false;
        }
        ...
        private bool CheckVoteValidation()
        {
            ...
            {
                if (int.TryParse(txtIdVoto.Text, out test) && int.TryParse(txtIdStudenteVoto.Text, out int test2) &&
                    int.TryParse(txtIdMateriaVoto.Text, out test) && int.TryParse(txtVoto.Text, out test) && 
                    DateTime.TryParse(txtDataVoto.Text, out DateTime dateTest))
                        return true;
            }
            return false;
        }
